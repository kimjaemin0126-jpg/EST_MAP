    ...
    def scenario_payload(payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "scenario": {
                ...
                "investment_payback_months": None if investment_payback_months is None else round(investment_payback_months, 1),
                "market_stress": {
                    "quadrant": quadrant["title"],
                    ...
                    "runway_months": None if stress_runway_months is None else round(stress_runway_months, 1),
                    "interpretation": quadrant["interpretation"],
                    "field_check": quadrant["check"],
                },
            },

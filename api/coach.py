...
from analysis_core import generate_coach, scenario_payload  # noqa: E402
...
class handler(ApiHandler):
    def do_POST(self) -> None:  # noqa: N802
        try:
            ...
            self.json_response({"error": f"코치 분석 중 서버 오류가 발생했습니다: {type(error).__name__}"}, HTTPStatus.INTERNAL_SERVER_ERROR)

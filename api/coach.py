...
This wrapper calls `generate_coach` from the application core and returns the
structured coach JSON. It mirrors the deployment entrypoint used in
open-safe-ai-main so Vercel can discover and run it as a Python Function.
"""
